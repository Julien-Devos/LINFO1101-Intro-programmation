class Coureur:
    ...
    def __hash__(self):
        ...
        Coureur comme clé d'une dictionnaire, comme dans notre implémentation native du classement.
        Remarque: Pour votre implémentation vous pouvez ignorer cette méthode; elle n'est pas importante
                  si on stocke les résultats dans une liste chainée plutôt que dans une dictionnaire.
        """
